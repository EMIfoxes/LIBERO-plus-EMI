import os
os.environ["LIBERO_CONFIG_PATH"] = "/home/lxx/project/LIBERO-plus/libero/configs"
import collections
import dataclasses
import logging
import math
...
class Args:
    ...
    # Utils
    #################################################################################################################
    video_out_path: str = "./eval_results/libero_videos"  # Path to save videos
...
def eval_libero(args: Args) -> None:
    ...
    name_to_category = {}
    with open("/home/lxx/project/LIBERO-plus/libero/libero/benchmark/task_classification.json", "r") as f:
